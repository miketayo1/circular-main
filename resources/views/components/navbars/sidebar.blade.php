...
<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0 d-flex text-wrap align-items-center" href=" {{ route('dashboard') }} ">
            <img src="{{ URL::to('/logo/lagos.png')}}" class="navbar-brand-img h-100" alt="main_logo">
            <span class="ms-2 font-weight-bold text-white"><Fieldset>File Manager</Fieldset></span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <!-- <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">Teen Africa TV</h6>
            </li> -->
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'configuration' ? ' active bg-gradient-primary' : '' }} "
                    href="{{route('get-log')}} ">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">stadium</i>
                    </div>
